...
if (!document.getElementById('regStyle')) {
    ...
    rs.textContent = [
        ...
        '.cb-reg-badge { display:flex; flex-direction:column; align-items:center; gap:1px; width:24px; flex-shrink:0; padding-top:2px; }',
        '.cb-reg-num { font-size:0.5rem; font-weight:900; color:rgba(255,255,255,0.15); line-height:1; }',
        '.cb-reg-ico { font-size:0.7rem; line-height:1; filter:drop-shadow(0 0 4px currentColor); display:flex; align-items:center; justify-content:center; width:18px; height:18px; }',
        ...
        '.cb-reg-name { font-weight:700; font-size:0.68rem; color:rgba(255,255,255,0.9); overflow:hidden; text-overflow:ellipsis; white-space:nowrap; min-width:0; flex-shrink:1; cursor:text; padding:0 4px; border-radius:3px; transition:background .12s,color .12s; }',
        ...
        '.cb-reg-tag { padding:0px 5px; border-radius:3px; font-weight:800; text-transform:uppercase; letter-spacing:0.3px; font-size:0.42rem; flex-shrink:0; line-height:1.4; }',
        ...
        '.cb-reg-setting { display:inline-flex; align-items:center; gap:2px; padding:2px 6px; border-radius:4px; border:1.5px dashed rgba(255,255,255,0.07); background:transparent; cursor:pointer; user-select:none; font-size:0.48rem; font-weight:800; color:rgba(255,255,255,0.25); transition:all .15s; }',
        ...
        '.cb-reg-setting .si { background:transparent !important; border:none !important; padding:0 !important; color:#fff !important; font-weight:700 !important; width:24px; text-align:center; font-size:0.5rem; pointer-events:none; opacity:.35; transition:opacity .2s; min-height:14px; outline:none; }',
        '.cb-reg-setting.on .si { opacity:1; pointer-events:auto; }',
        '.cb-reg-setting .sl { font-size:0.4rem; font-weight:800; letter-spacing:.2px; text-transform:uppercase; opacity:.5; }',
