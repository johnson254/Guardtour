...
if (!document.getElementById('regStyle')) {
    ...
    rs.id = 'regStyle';
    rs.textContent = [
        '.cb-reg-row { display:flex; align-items:flex-start; gap:4px; padding:5px 6px; background:rgba(255,255,255,0.015); border-radius:8px; border:1px solid rgba(255,255,255,0.05); border-left:3px solid; margin-bottom:3px; transition:border-color .2s,background .2s,box-shadow .2s,transform .15s; position:relative; animation:regSlideIn .22s ease; cursor:pointer; }',
        ...
        '.cb-reg-badge { display:flex; flex-direction:column; align-items:center; gap:1px; width:22px; flex-shrink:0; padding-top:2px; }',
        '.cb-reg-num { font-size:0.48rem; font-weight:900; color:rgba(255,255,255,0.15); line-height:1; }',
        '.cb-reg-ico { font-size:0.55rem; line-height:1; filter:drop-shadow(0 0 4px currentColor); }',
        '.cb-reg-body { flex:1; min-width:0; display:flex; flex-direction:column; }',
        '.cb-reg-hd { display:flex; align-items:center; gap:5px; cursor:pointer; padding:1px 2px; border-radius:5px; transition:background .12s; }',
        '.cb-reg-hd:hover { background:rgba(255,255,255,0.025); }',
        '.cb-reg-name { font-weight:800; font-size:0.65rem; color:rgba(255,255,255,0.9); overflow:hidden; text-overflow:ellipsis; white-space:nowrap; min-width:0; flex-shrink:1; cursor:text; padding:0 2px; border-radius:3px; transition:background .12s,color .12s; }',
        ...
        '.cb-reg-tag { padding:0 5px; border-radius:3px; font-weight:800; text-transform:uppercase; letter-spacing:0.3px; font-size:0.42rem; flex-shrink:0; line-height:1.4; }',
        ...
        '.cb-reg-dot { display:inline-flex; align-items:center; gap:2px; font-size:0.38rem; padding:1px 4px; border-radius:4px; opacity:0.8; transition:opacity .15s,transform .12s; }',
        '.cb-reg-dot:hover { opacity:1; transform:scale(1.08); }',
        '.cb-reg-dot i { font-size:0.35rem; }',
        '.cb-reg-dot span { font-size:0.4rem; font-weight:800; letter-spacing:.2px; }',
        ...
        '.cb-reg-chev { font-size:0.45rem; opacity:0.12; transition:transform .3s cubic-bezier(.4,0,.2,1),opacity .2s; margin-left:auto; flex-shrink:0; display:flex; align-items:center; }',
        ...
        '.cb-reg-field-row { display:flex; flex-wrap:wrap; gap:5px; align-items:flex-end; padding:5px 2px 4px 2px; border-bottom:1px solid rgba(255,255,255,0.03); margin-bottom:3px; }',
        '.cb-reg-field { display:flex; flex-direction:column; gap:1px; min-width:55px; flex:1; }',
        '.cb-reg-field label { font-size:0.38rem; font-weight:800; color:rgba(255,255,255,0.18); text-transform:uppercase; letter-spacing:0.4px; padding-left:2px; }',
        '.cb-reg-field input { background:rgba(25,25,40,0.6); border:1px solid rgba(255,255,255,0.05); border-radius:5px; padding:3px 6px; font-size:0.58rem; color:#fff; outline:none; transition:border-color .15s,background .15s,box-shadow .15s; }',
        ...
        '.cb-reg-enf .enf-card { margin-bottom:0 !important; border-radius:6px; border-color:rgba(255,255,255,0.04); }',
        '.cb-reg-enf .enf-card-head { padding:5px 7px !important; }',
        '.cb-reg-enf .enf-card-icon { width:22px !important; height:22px !important; border-radius:5px !important; font-size:0.5rem !important; }',
        '.cb-reg-enf .enf-card-label { font-size:0.48rem !important; }',
        '.cb-reg-enf .enf-card-desc { font-size:0.38rem !important; }',
        '.cb-reg-enf .enf-card-value { font-size:0.75rem !important; }',
        '.cb-reg-enf .enf-card-value small { font-size:0.42rem !important; }',
        '.cb-reg-enf .enf-card-body { padding:0 7px 4px !important; }',
        '.cb-reg-enf .enf-slider { height:4px !important; }',
        '.cb-reg-enf .enf-slider::-webkit-slider-thumb { width:14px !important; height:14px !important; border-width:1.5px !important; }',
        '.cb-reg-enf .enf-preset { padding:2px 1px !important; font-size:0.42rem !important; border-radius:4px !important; }',
        // Target time chip in registry
        '.cb-reg-setting { display:inline-flex; align-items:center; gap:2px; padding:2px 6px; border-radius:5px; border:1.5px dashed rgba(255,255,255,0.07); background:transparent; cursor:pointer; user-select:none; font-size:0.48rem; font-weight:800; color:rgba(255,255,255,0.25); transition:all .15s; }',
        ...
        '.cb-reg-setting i { font-size:0.45rem; opacity:.4; }',
        '.cb-reg-setting.on i { opacity:.8; }',
        '.cb-reg-setting .si { background:transparent !important; border:none !important; padding:0 !important; color:#fff !important; font-weight:700 !important; width:22px; text-align:center; font-size:0.5rem; pointer-events:none; opacity:.35; transition:opacity .2s; min-height:14px; outline:none; }',
        '.cb-reg-setting.on .si { opacity:1; pointer-events:auto; }',
        '.cb-reg-setting .sl { font-size:0.42rem; font-weight:800; letter-spacing:.3px; text-transform:uppercase; opacity:.5; }',
        '.cb-reg-setting.on .sl { opacity:1; }',
        '.cb-reg-actions { display:flex; flex-direction:column; align-items:center; gap:2px; flex-shrink:0; padding-top:1px; }',
        '.cb-reg-saved { font-size:0.38rem; color:rgba(255,255,255,0.1); padding:1px; }',
        '.cb-r-btn { background:none; border:none; color:rgba(255,255,255,0.15); cursor:pointer; padding:2px 3px; border-radius:4px; font-size:0.5rem; transition:all .12s; display:flex; align-items:center; justify-content:center; }',
...
window.addRegistryRow = function(type, data) {
    ...
    var fieldArea = type === 'nfc' ? [
        ...
        '<div class="cb-reg-field-row">',
            '<div class="cb-reg-field"><label class="rs-lbl">Point Name</label><input class="rs-fi rs-fi-sm cp-inline-name" value="' + name + '" placeholder="e.g. Peer Audit Point"></div>',
            '<div class="cb-reg-field"><label class="rs-lbl">Auditor</label><input class="rs-fi rs-fi-sm cp-inline-auditor" value="' + auditor + '" placeholder="Callsign"></div>',
            '<div class="cb-reg-field"><label class="rs-lbl">Target</label><input class="rs-fi rs-fi-sm cp-inline-target" value="' + target + '" placeholder="Callsign"></div>',
        '</div>'
    ].join('');
                ...
                '<div class="cb-reg-config-inner">',
                    ...
                    '<div class="cb-reg-enf" style="display:flex;flex-direction:column;gap:4px;padding:0 0 2px;">',
                        ...
                        '<div class="enf-card" style="margin-bottom:0;">',
                            '<div class="enf-card-head" style="padding:6px 8px;">',
                                '<div class="enf-card-icon" style="width:26px;height:26px;border-radius:6px;background:rgba(211,47,47,0.12);color:#d32f2f;font-size:0.6rem;"><i class="fas fa-circle-dot"></i></div>',
                                '<div class="enf-card-info"><div class="enf-card-label" style="font-size:0.5rem;">Radius</div><div class="enf-card-desc" style="font-size:0.4rem;">Detection perimeter</div></div>',
                                '<div class="enf-card-value cp-rad-val" style="font-size:0.9rem;">' + (rad || 0) + '<small>m</small></div>',
                            '</div>',
                            '<div class="enf-card-body" style="padding:0 8px 6px;">',
                        ...
                        '<div class="enf-card" style="margin-bottom:0;">',
                            '<div class="enf-card-head" style="padding:6px 8px;">',
                                '<div class="enf-card-icon" style="width:26px;height:26px;border-radius:6px;background:rgba(239,159,39,0.12);color:#EF9F27;font-size:0.6rem;"><i class="fas fa-stopwatch"></i></div>',
                                '<div class="enf-card-info"><div class="enf-card-label" style="font-size:0.5rem;">Dwell</div><div class="enf-card-desc" style="font-size:0.4rem;">Minimum stay</div></div>',
                                '<div class="enf-card-value cp-dwell-val" style="font-size:0.9rem;">' + (dwell || 0) + '<small>min</small></div>',
                            '</div>',
                            '<div class="enf-card-body" style="padding:0 8px 6px;">',
                        ...
                        '<div class="enf-card" style="margin-bottom:0;">',
                            '<div class="enf-card-head" style="padding:6px 8px;">',
                                '<div class="enf-card-icon" style="width:26px;height:26px;border-radius:6px;background:rgba(108,142,239,0.12);color:#6C8EEF;font-size:0.6rem;"><i class="fas fa-hourglass-start"></i></div>',
                                '<div class="enf-card-info"><div class="enf-card-label" style="font-size:0.5rem;">Tolerance</div><div class="enf-card-desc" style="font-size:0.4rem;">Grace window</div></div>',
                                '<div class="enf-card-value cp-tol-val" style="font-size:0.9rem;">' + (tol || 0) + '<small>min</small></div>',
                            '</div>',
                            '<div class="enf-card-body" style="padding:0 8px 6px;">',
                        ...
                        '</div>',
                        // Target time chip
                        '<div class="cb-reg-setting ' + (time ? 'on' : '') + '" onclick="rsToggleProp(event,this)" style="margin-top:2px;">',
                            '<i class="fas fa-clock"></i>',
                            '<input type="time" class="si cp-inline-time" value="' + time + '">',
